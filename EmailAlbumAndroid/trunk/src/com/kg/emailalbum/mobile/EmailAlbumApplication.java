...
public class EmailAlbumApplication extends CrashReportingApplication {
    ...
    public Bundle getCrashResources() {
        ...
        result.putInt(RES_DIALOG_OK_TOAST, R.string.crash_dialog_ok_toast); // optional. Displays a Toast when the user accpets to send a report ("Thank you !" for example)
        return result;
    }
